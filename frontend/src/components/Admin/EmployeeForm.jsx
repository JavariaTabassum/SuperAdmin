  ...
  return (
    ...
    <div className="flex font-inter justify-center items-center ">
      <div className="p-8 w-full max-w-4xl">
        ...
        <form>
          <div className="grid text-[rgba(68,68,68,1)] col grid-cols-2 gap-x-6">
            <div>
            <div className='mb-5'>
            ...
            <div className='mb-5'>
              <label className="block text-md font-inter">Designation</label>
              <input
                type="text"
                className="mt-1 block w-full rounded-md p-3 border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
          ...
          <div>
            ...
            <input
              type="password"
              className="mt-1 block w-full rounded-md  p p-3 border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
            ...
            <div>
              <label className="block text-md font-inter">Employee ID</label>
              <input
                type="text"
                className="mt-1 block w-full rounded-md p-3 border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                defaultValue="9642677232"
