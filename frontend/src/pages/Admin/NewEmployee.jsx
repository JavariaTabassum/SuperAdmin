...
import EmployeeAccess from '../../components/Admin/EmployeeAccess';
 ...
 <style>
      ...
      <div className="flex flex-col flex-1 overflow-x-hidden ml-4 margin"> 
        ...
        <div className="flex flex-col flex-1 overflow-x-hidden">
          <h2 className="mt-10 text-3xl font-ibm-plex"  style={{ color: "rgba(5, 15, 36, 1)", fontWeight: "500" }}>Add Employee</h2>
